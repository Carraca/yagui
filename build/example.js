...
menutopbar1.addSlider(
  "Slider" /*initValueOrObject, callbackOrKey, min, max, step*/
);
menutopbar1.addCombobox(
  "Combo" /*, initValueOrObject, callbackOrKey, options*/
);
...
menutopbar1.addColor(
  "Color" /*initValueOrObject, callbackOrKey */,
  null,
  computeGradient
);
...
topbar.addUndoButton("Undo Button" /*,callbackOrObject, key*/);
topbar.addRedoButton("Redo Button" /*,callbackOrObject, key*/);
...
menuright2.addDualButton(
  "button1",
  "button2" /*, callbackOrObject1, callbackOrObject2, key1, key2*/
);
